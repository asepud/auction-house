...
public class AuctionServiceImpl implements AuctionService {
    ...
    public AuctionServiceImpl(AuctionItemRepository items, CategoryRepository categories, UserRepository users,
            BidRepository bids, PaymentService payments, NotificationService notifications) {
        this.items = items;
    ...
    private ItemResponse closeItem(AuctionItem i) {
        ...
        if (highest.isEmpty()) {
            ...
            notifications.send(i.getSeller().getId(), NotificationType.AUCTION_ENDED,
            ...
            notifications.send(b.getBidder().getId(), NotificationType.WINNER,
